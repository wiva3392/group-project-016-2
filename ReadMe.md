...
Run Instructions:
  cd group-project-016-2/ProjectSourceCode/
  sudo docker compose up (must have a .env set up)
  open in browser "http://localhost:3000/login"
  use the buttons to register, login, and discover the pages
